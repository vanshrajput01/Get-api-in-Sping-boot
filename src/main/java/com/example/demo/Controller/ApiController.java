...
public class ApiController {
	...
	public ResponseEntity<CommanResponse> getData(@PathVariable(value = "userid") Integer id){
		...
		return new ResponseEntity<>(responseUtils.prepareResponse(HttpStatus.OK.value(),ApplicationConstraints.SUCCESS_MSG,this.apiService.getData(id)),HttpStatus.OK);
	}
